...
description: katana-document-preview の実装が OpenSpec の提案、設計、仕様差分、tasks.md と一致しているか確認する。archive や PR 前の最終確認で使う。
---
...
6. 正しさを確認する。
   ...
   - document preview の失敗経路がテストされているか。
   - document preview、egui implementation、boundary lint が仕様どおりか。
...
7. 整合性を確認する。
   ...
   - UI、翻訳、アイコン、release など kdp 外の関心が混ざっていないか。
