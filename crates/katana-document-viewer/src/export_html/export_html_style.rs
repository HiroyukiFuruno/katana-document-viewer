...
const STATIC_STYLE: &str = concat!(
    ...
    "[data-kdv-blockquote=\"alert\"]{border-left:4px solid var(--kdv-quote-border);background:var(--kdv-alert-bg);margin:1rem 0;padding:.75rem 1rem;}",
    ...
    "span[data-kdv-task-visual=\"in-progress-dash\"],span[data-kdv-task-visual=\"in-progress-slash\"]{background:var(--kdv-task-active-bg);color:var(--kdv-task-progress);}",
    ...
    "span[data-kdv-task-visual=\"in-progress-dash\"]::before{content:\"\";width:.62em;border-top:.14em solid currentColor;}",
