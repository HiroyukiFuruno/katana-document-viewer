...
#[test]
fn file_length_rule_skips_short_files() -> Result<(), KdvLintError> {
...
#[test]
fn file_length_rule_reports_long_file() -> Result<(), KdvLintError> {
    let fixture = FixtureWorkspace::new().with_default_manifests()?;
    fixture.write_rust_file(
    ...
    let violation = long_violation.ok_or_else(|| KdvLintError::WorkspaceRoot {
...
#[test]
fn violation_line_column_are_reported_from_file_root() -> Result<(), KdvLintError> {
    let fixture = FixtureWorkspace::new().with_default_manifests()?;
    fixture.write_rust_file(
        "crates/katana-document-viewer/src/too_long.rs",
        &"fn x() {}\n".repeat(201),
    ...
    let first = long_violation.ok_or(KdvLintError::WorkspaceRoot {
        path: fixture.root.clone(),
    })?;
...
#[test]
fn file_length_rule_tolerates_exact_limit() -> Result<(), KdvLintError> {
    let fixture = FixtureWorkspace::new().with_default_manifests()?;
    fixture.write_rust_file(
