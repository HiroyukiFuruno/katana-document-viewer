...
mod tests {
    ...
    #[test]
    fn function_length_rule_ignores_short_functions() -> Result<(), KdvLintError> {
    ...
    #[test]
    fn function_length_rule_flags_long_fn_item() -> Result<(), KdvLintError> {
        let fixture = FixtureWorkspace::new().with_default_manifests()?;
        let body = "    let _ = 1;\n".repeat(33);
    ...
    #[test]
    fn function_length_rule_checks_impl_item_fn() -> Result<(), KdvLintError> {
        let fixture = FixtureWorkspace::new().with_default_manifests()?;
        let body = "        let _ = 1;\n".repeat(33);
        let source =
