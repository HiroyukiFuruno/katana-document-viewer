...
mod tests {
    ...
    #[test]
    fn nesting_depth_rule_reports_excessive_nesting() -> Result<(), KdvLintError> {
...
"#;
    ...
    #[test]
    fn nesting_depth_rule_allows_valid_depth() -> Result<(), KdvLintError> {
        let fixture = FixtureWorkspace::new().with_default_manifests()?;
        let source = r#"
fn nested() {
    if true {
...
"#;
    ...
    #[test]
    fn nesting_depth_rule_checks_loop_and_match_forms() -> Result<(), KdvLintError> {
        let fixture = FixtureWorkspace::new().with_default_manifests()?;
        let source = r#"
fn nested() {
    for _ in 0..2 {
