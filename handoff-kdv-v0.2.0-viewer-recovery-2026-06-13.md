...
注意: `openspec tasks` は完了扱いでも、ユーザー指摘台帳は未完了。現状判断は OpenSpec change 配下の `openspec/changes/v0-2-0-markdown-viewer-kuc-integration/user-feedback-todo.md` と実画面を優先する。
