...
- 進める: `DocumentSource`、`DocumentSnapshot`、`Artifact*`、`BuildRequest`、`ExportRequest`、`ExportOutput`、描画評価の検証用入力（fixture）、KRR委譲境界、KMM DTO coverage gapのdiagnostics、コマンド実行口（CLI）から呼べるAPI。
