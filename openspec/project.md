...
KDVは、KME public DTOを入力にしたMarkdown viewer、hit-test、node選択、HTML/PDF/PNG/JPG exportを担うlibraryである。KatanA はこれを git dependency として consume する。
...
- `v0.1.x`: KDV改名、KME model input、Floem viewer、viewer/export pipeline方針の確立。
...
KME構想ではP3として、P0 `katana-ast-lint`、P1 `katana-markdown-engine`、P2 `katana-ui-widget` の境界を受けて、KME文書モデルをFloemで表示し、同じpipelineでexportする。
